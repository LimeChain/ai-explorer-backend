...
class MirrorNodeClient:
    ...
    def __enter__(self) -> "MirrorNodeClient":
        return self
    ...
    @classmethod
    def for_testnet(cls, **kwargs) -> "MirrorNodeClient":
        """Create a client for Hiero testnet."""
        return cls(get_network_urls()["testnet"], **kwargs)

    @classmethod
    def for_previewnet(cls, **kwargs) -> "MirrorNodeClient":
        """Create a client for Hiero previewnet."""
    ...
    def get_accounts(
        ...
        response = self._get("/api/v1/accounts", params)
    ...
    def get_account(
        ...
        response = self._get(f"/api/v1/accounts/{account_id}", params)
    ...
    def get_account_nfts(
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/nfts", params)
        return self._parse_response(response, NftsResponse)

    def get_account_staking_rewards(
        self,
        account_id: str,
        limit: Optional[int] = None,
        order: Optional[str] = None,
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/rewards", params)
    ...
    def get_account_tokens(
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/tokens", params)
        return self._parse_response(response, TokenRelationshipResponse)

    def get_account_pending_airdrops(
        self,
        account_id: str,
        limit: Optional[int] = None,
        order: Optional[str] = None,
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/airdrops/pending", params)
        return self._parse_response(response, TokenAirdropsResponse)

    def get_account_outstanding_airdrops(
        self,
        account_id: str,
        limit: Optional[int] = None,
        order: Optional[str] = None,
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/airdrops/outstanding", params)
        return self._parse_response(response, TokenAirdropsResponse)

    def get_account_crypto_allowances(
        self,
        account_id: str,
        limit: Optional[int] = None,
        order: Optional[str] = None,
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/allowances/crypto", params)
        return self._parse_response(response, CryptoAllowancesResponse)

    def get_account_token_allowances(
        self,
        account_id: str,
        limit: Optional[int] = None,
        order: Optional[str] = None,
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/allowances/tokens", params)
        return self._parse_response(response, TokenAllowancesResponse)

    def get_account_nft_allowances(
        self,
        account_id: str,
        limit: Optional[int] = None,
        order: Optional[str] = None,
        ...
        response = self._get(f"/api/v1/accounts/{account_id}/allowances/nfts", params)
    ...
    def get_balances(
        ...
        response = self._get("/api/v1/balances", params)
    ...
    def get_blocks(
        ...
        response = self._get("/api/v1/blocks", params)
        return self._parse_response(response, BlocksResponse)

    def get_block(self, hash_or_number: str) -> Block:
        ...
        Returns:
            Block information
        """
        response = self._get(f"/api/v1/blocks/{hash_or_number}")
        return self._parse_response(response, Block)

    # Contract endpoints

    def call_contract(self, request: Dict[str, Any]) -> ContractCallResponse:
        ...
        """
        response = self._post("/api/v1/contracts/call", request)
    ...
    def get_contracts(
        ...
        response = self._get("/api/v1/contracts", params)
    ...
    def get_contract(
        ...
        response = self._get(f"/api/v1/contracts/{contract_id}", params)
    ...
    def get_contract_results(
        ...
        Args:
            ...
            block_number: Filter by block number
            internal: Include internal transactions
            limit: Maximum number of results
            order: Sort order (asc/desc)
            timestamp: Filter by timestamp
            transaction_index: Filter by transaction index

        Returns:
            ContractResultsResponse with contract result information
        """
        params = build_query_params(
        ...
        if contract_id:
            path = f"/api/v1/contracts/{contract_id}/results"
        else:
            path = "/api/v1/contracts/results"
        
        response = self._get(path, params)
        return self._parse_response(response, ContractResultsResponse)
    ...
    def get_contract_result(
        ...
        """Get a specific contract result.
        ...
        Returns:
            ContractResultDetails with detailed result information
        """
        response = self._get(f"/api/v1/contracts/{contract_id}/results/{timestamp}")
        return self._parse_response(response, ContractResultDetails)

    def get_contract_result_by_transaction(
        self,
        transaction_id_or_hash: str,
        nonce: Optional[int] = None,
    ) -> ContractResultDetails:
        """Get a contract result by transaction ID or hash.

        Args:
            transaction_id_or_hash: Transaction ID or hash
            nonce: Transaction nonce

        Returns:
            ContractResultDetails with detailed result information
        """
        params = build_query_params(nonce=nonce)
        
        response = self._get(f"/api/v1/contracts/results/{transaction_id_or_hash}", params)
        return self._parse_response(response, ContractResultDetails)
    ...
    def get_contract_logs(
        ...
        Args:
            contract_id: Filter by contract ID
            index: Filter by log index
            limit: Maximum number of results
            order: Sort order (asc/desc)
            timestamp: Filter by timestamp
            topic0: Filter by topic 0
            topic1: Filter by topic 1
            topic2: Filter by topic 2
            topic3: Filter by topic 3
            transaction_hash: Filter by transaction hash

        Returns:
            ContractLogsResponse with contract log information
        """
        params = build_query_params(
            index=index,
            limit=validate_limit(limit),
        ...
        response = self._get(path, params)
        return self._parse_response(response, ContractLogsResponse)
    ...
    def get_contract_state(
        ...
        Returns:
            ContractStateResponse with contract state information
        """
        params = build_query_params(
            limit=validate_limit(limit),
            order=normalize_order(order),
        ...
        response = self._get(f"/api/v1/contracts/{contract_id}/state", params)
        return self._parse_response(response, ContractStateResponse)

    # Network endpoints

    def get_network_exchange_rate(
        self,
        timestamp: Optional[str] = None,
        ...
        response = self._get("/api/v1/network/exchangerate", params)
    ...
    def get_network_fees(
        ...
        response = self._get("/api/v1/network/fees", params)
    ...
    def get_network_supply(
        ...
        response = self._get("/api/v1/network/supply", params)
    ...
    def get_schedules(
        ...
        response = self._get("/api/v1/schedules", params)
    ...
    def get_schedule(self, schedule_id: str) -> Schedule:
        ...
        """
        response = self._get(f"/api/v1/schedules/{schedule_id}")
    ...
    def get_transaction(
        ...
        response = self._get(f"/api/v1/transactions/{transaction_id}", params)
    ...
    def get_topic(self, topic_id: str) -> Topic:
        ...
        Returns:
            Topic information
        """
        response = self._get(f"/api/v1/topics/{topic_id}")
    ...
    def get_topic_messages(
        ...
        response = self._get(f"/api/v1/topics/{topic_id}/messages", params)
    ...
    def get_topic_message(
        ...
        """
        response = self._get(f"/api/v1/topics/{topic_id}/messages/{sequence_number}")
        return self._parse_response(response, TopicMessage)

    def get_topic_message_by_timestamp(self, timestamp: str) -> TopicMessage:
        ...
        Returns:
            TopicMessage information
        """
        response = self._get(f"/api/v1/topics/messages/{timestamp}")
        return self._parse_response(response, TopicMessage)
    ...
    def get_tokens(
        ...
        response = self._get("/api/v1/tokens", params)
    ...
    def get_token(
        ...
        response = self._get(f"/api/v1/tokens/{token_id}", params)
    ...
    def get_token_balances(
        ...
        response = self._get(f"/api/v1/tokens/{token_id}/balances", params)
    ...
    def get_token_nfts(
        ...
        response = self._get(f"/api/v1/tokens/{token_id}/nfts", params)
        return self._parse_response(response, NftsResponse)

    def get_nft(self, token_id: str, serial_number: int) -> Nft:
        """Get a specific NFT.
        ...
        Returns:
            Nft information
        """
        response = self._get(f"/api/v1/tokens/{token_id}/nfts/{serial_number}")
    ...
    def get_nft_transaction_history(
        ...
        response = self._get(f"/api/v1/tokens/{token_id}/nfts/{serial_number}/transactions", params)
